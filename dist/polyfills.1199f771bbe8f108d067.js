      ...
      !(function() {
        ...
        !(function(e) {
          ...
          var o,
            a = (function() {
              ...
              return (
                ...
                (t.prototype.runTask = function(e, t, n) {
                  ...
                  if (e.state !== y || e.type !== S) {
                    var r = e.state != _;
                    r && e._transitionTo(_, m), e.runCount++;
                    var o = O;
                    (O = e), (z = { parent: z, zone: this });
                    try {
                      ...
                      e.state !== y &&
                        ...
                        (e.type == S || (e.data && e.data.isPeriodic)
                          ? r && e._transitionTo(m, _)
                          : ((e.runCount = 0), this._updateTaskCount(e, -1), r && e._transitionTo(y, _, y))),
                        (z = z.parent),
                        (O = o);
                    }
                  }
                ...
                (t.prototype.scheduleTask = function(e) {
                  ...
                  try {
                    ...
                    throw (e._transitionTo(T, k, y), this._zoneDelegate.handleError(this, r), r);
                  }
                  return (
                    e._zoneDelegates === n && this._updateTaskCount(e, 1), e.state == k && e._transitionTo(m, k), e
                  );
                }),
                (t.prototype.scheduleMicroTask = function(e, t, n, r) {
                  return this.scheduleTask(new c(w, e, t, n, r, null));
                }),
                (t.prototype.scheduleMacroTask = function(e, t, n, r, o) {
                  return this.scheduleTask(new c(E, e, t, n, r, o));
                }),
                (t.prototype.scheduleEventTask = function(e, t, n, r, o) {
                  return this.scheduleTask(new c(S, e, t, n, r, o));
                }),
            ...
            h = !1;
          function d(t) {
            0 === P && 0 === f.length && (o || (e[l] && (o = e[l].resolve(0))), o ? o[p](v) : e[u](v, 0)),
              t && f.push(t);
          }
          function v() {
            if (!h) {
          ...
          var g = { name: 'NO ZONE' },
            ...
            z = { parent: null, zone: new a(null, null) },
            O = null,
            P = 0;
          function j() {}
          function C(e) {
          ...
          Zone.__load_patch('ZoneAwarePromise', function(e, t, n) {
            ...
            var D = function() {
              ...
              z = a('currentTaskTrace');
            function O(e, r, a) {
              var s,
                c = D();
              if (e === a) throw new TypeError(Z);
              if (e[v] === b) {
                var l = null;
                try {
                ...
                if (r !== w && a instanceof I && a.hasOwnProperty(v) && a.hasOwnProperty(g) && a[v] !== b)
                  j(a), O(e, a[v], a[g]);
                else if (r !== w && 'function' == typeof l)
                  try {
                    l.call(a, c(S(e, r)), c(S(e, !1)));
                  } catch (_) {
                    c(function() {
                      O(e, !1, _);
                    })();
                  ...
                  var p = e[g];
                  if (
                    ((e[g] = a), e[y] === y && r === T && ((e[v] = e[m]), (e[g] = e[k])), r === w && a instanceof Error)
                  ) {
                    var f = t.currentTask && t.currentTask.data && t.currentTask.data[u];
                    f && o(a, z, { configurable: !0, enumerable: !1, writable: !0, value: f });
                  }
                  ...
                  if (0 == p.length && r == w) {
                    ...
                    try {
                      throw new Error(
                        'Uncaught (in promise): ' +
                          ((s = a) && s.toString === Object.prototype.toString
              ...
              return (
                ...
                (e.prototype.then = function(e, n) {
                  var r = new this.constructor(null),
                    o = t.current;
                  return this[v] == b ? this[g].push(o, r, e, n) : C(this, o, r, e, n), r;
                }),
                ...
                (e.prototype.finally = function(e) {
                  ...
                  n[y] = y;
                  var r = t.current;
                  return this[v] == b ? this[g].push(r, n, e, e) : C(this, r, n, e, e), n;
                }),
                e
              );
            })();
            ...
            (R && !R.configurable) ||
              ...
              (R.set = function(t) {
                t === I ? (e[M] = t) : ((e[s] = t), t.prototype[c] || F(t), n.setNativePromise(t));
              }),
              o(e, 'Promise', R)),
              (e.Promise = I);
            var H,
            ...
            return (Promise[t.__symbol__('uncaughtPromiseErrors')] = i), I;
          });
        ...
        var T = 'undefined' != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope,
          ...
          E = !w && !T && !(!v || !g.HTMLElement),
          S =
            void 0 !== y.process && '[object process]' === {}.toString.call(y.process) && !T && !(!v || !g.HTMLElement),
          D = {},
          Z = function(e) {
            if ((e = e || y.event)) {
              var t = D[e.type];
              t || (t = D[e.type] = d('ON_PROPERTY' + e.type));
        ...
        function z(n, r, o) {
          ...
          if ((!a && o && e(o, r) && (a = { enumerable: !0, configurable: !0 }), a && a.configurable)) {
            ...
            var i = a.get,
              ...
              c = r.substr(2),
              u = D[c];
            u || (u = D[c] = d('ON_PROPERTY' + c)),
              (a.set = function(e) {
                var t = this;
                t || n !== y || (t = y),
                  t &&
                    (t[u] && t.removeEventListener(c, Z),
                    s && s.apply(t, m),
                    'function' == typeof e ? ((t[u] = e), t.addEventListener(c, Z, !1)) : (t[u] = null));
              }),
              (a.get = function() {
                var e = this;
                ...
                if (i) {
                  var o = i && i.call(this);
                  if (o) return a.set.call(this, o), 'function' == typeof e[k] && e.removeAttribute(r), o;
                }
                return null;
              }),
              t(n, r, a);
        ...
        function C(t, r, o) {
          ...
          var i,
            s = d(r);
          if (a && !(i = a[s]) && ((i = a[s] = a[r]), b(a && e(a, r)))) {
            var c = o(i, s, r);
            (a[r] = function() {
        ...
        function B(e, t, r) {
            ...
            m = function(t) {
              if ((t = t || e.event)) {
                ...
                if (r)
                  ...
                  else for (var o = r.slice(), a = 0; a < o.length && (!t || !0 !== t[A]); a++) k(o[a], n, t);
              }
            },
            _ = function(t) {
              if ((t = t || e.event)) {
          ...
          function b(t, r) {
            ...
            var O = a
                ? function() {
                    if (!E.isExisting) return S.call(E.target, E.eventName, E.capture ? _ : m, E.options);
                  }
                : function(e) {
              ...
              P = a
                ? function(e) {
                    ...
                    if (e.allRemoved) return D.call(e.target, e.eventName, e.capture ? _ : m, e.options);
                  }
                : function(e) {
              ...
              L = function(t, n, r, o, s, c) {
                return (
                  ...
                  function() {
                    ...
                    if (!i || i(t, h, f, arguments)) {
                      var v,
                        g = arguments[0],
                        y = arguments[2];
                      if (C) for (var m = 0; m < C.length; m++) if (g === C[m]) return t.apply(this, arguments);
                      var _ = !1;
                      void 0 === y
                        ? (v = !1)
                        : !0 === y
                      ...
                      if (w) b = w[v ? u : l];
                        ...
                        var S = p + (g + l),
                          D = p + (g + u);
                        (x[g] = {}), (x[g][l] = S), (x[g][u] = D), (b = v ? D : S);
                      }
                      var Z,
                        z = f[b],
                        O = !1;
                      if (z) {
                        if (((O = !0), k)) for (m = 0; m < z.length; m++) if (j(z[m], h)) return;
                      } else z = f[b] = [];
                      ...
                      var L = a ? H : null;
                      L && (L.taskData = E);
                      var M = T.scheduleEventTask(Z, h, L, r, o);
                      return (
                        (E.target = null),
                        L && (L.taskData = null),
                        _ && (y.once = !0),
                        ...
                        (M.capture = v),
                        (M.eventName = g),
                        d && (M.originalDelegate = h),
                        c ? z.unshift(M) : z.push(M),
                        s ? f : void 0
                      );
                    }
                  }
            ...
            return (
                    ...
                    for (var f = 0; f < p.length; f++) {
                      ...
                      if (j(h, a))
                        return (
                          p.splice(f, 1),
                          (h.isRemoved = !0),
                          0 === p.length && ((h.allRemoved = !0), (n[s] = null)),
                          h.zone.cancelTask(h),
                          b ? n : void 0
                        );
                    }
              ...
              (T[c] = function() {
                for (var t = [], n = N(this || e, arguments[0]), r = 0; r < n.length; r++) {
                  var o = n[r];
                  ...
                  if (r) {
                    ...
                    if (o) {
                      ...
                      for (h = 0; h < i.length; h++)
                        this[s].call(this, n, (c = i[h]).originalDelegate ? c.originalDelegate : c.callback, c.options);
                    }
                    if (a)
                      for (i = a.slice(), h = 0; h < i.length; h++) {
                        var c;
                        this[s].call(this, n, (c = i[h]).originalDelegate ? c.originalDelegate : c.callback, c.options);
                      }
                  }
              ...
              (n.args[0] = function() {
                try {
                  ...
                  (t.data && t.data.isPeriodic) ||
                    ('number' == typeof n.handleId ? delete i[n.handleId] : n.handleId && (n.handleId[W] = null));
                }
              }),
          ...
          (o = C(e, (t += r), function(n) {
            ...
            (a = C(e, n, function(t) {
              return function(n, r) {
                var o,
                  a = r[0];
                'number' == typeof a ? (o = i[a]) : (o = a && a[W]) || (o = a),
                  o && 'string' == typeof o.type
                    ? 'notScheduled' !== o.state &&
                      ((o.cancelFn && o.data.isPeriodic) || 0 === o.runCount) &&
                      ('number' == typeof a ? delete i[a] : a && (a[W] = null), o.zone.cancelTask(o))
                    : t.apply(e, r);
              };
            }));
        }
        var G = (Object[d('defineProperty')] = Object.defineProperty),
          U = (Object[d('getOwnPropertyDescriptor')] = Object.getOwnPropertyDescriptor),
          V = Object.create,
          J = d('unconfigurables');
        function K(e, t) {
          return e && e[J] && e[J][t];
        ...
        function Y(e, t, n) {
          return (
            ...
            n.configurable ||
              (e[J] || Object.isFrozen(e) || G(e, J, { writable: !0, value: {} }), e[J] && (e[J][t] = !0)),
            n
          );
        }
        function Q(e, t, n, r) {
        ...
        function le(s, c) {
          if (!w || S) {
            ...
            if (
              (function() {
                if ((E || S) && !e(HTMLElement.prototype, 'onclick') && 'undefined' != typeof Element) {
                ...
                if (o) {
                  ...
                  return t(r, 'onreadystatechange', o || {}), a;
                }
                var i = d('fake');
                t(r, 'onreadystatechange', {
                  enumerable: !0,
              ...
              if (E) {
                var p = window;
                ue(p, ce.concat(['messageerror']), l, n(p)),
                  ue(Document.prototype, ce, l),
                  void 0 !== p.SVGElement && ue(p.SVGElement.prototype, ce, l),
                  ue(Element.prototype, ce, l),
                  ue(HTMLElement.prototype, ce, l),
                  ue(HTMLMediaElement.prototype, ee, l),
                  ue(HTMLFrameSetElement.prototype, $.concat(ne), l),
                  ue(HTMLBodyElement.prototype, $.concat(ne), l),
                  ue(HTMLFrameElement.prototype, te, l),
                  ue(HTMLIFrameElement.prototype, te, l);
                var h = p.HTMLMarqueeElement;
                h && ue(h.prototype, re, l);
                var v = p.Worker;
                v && ue(v.prototype, se, l);
              }
              ue(XMLHttpRequest.prototype, oe, l);
              var g = c.XMLHttpRequestEventTarget;
              g && ue(g && g.prototype, oe, l),
                'undefined' != typeof IDBIndex &&
                  (ue(IDBIndex.prototype, ae, l),
                  ue(IDBRequest.prototype, ae, l),
                  ue(IDBOpenDBRequest.prototype, ae, l),
                  ue(IDBDatabase.prototype, ae, l),
                  ue(IDBTransaction.prototype, ae, l),
                  ue(IDBCursor.prototype, ae, l)),
                u && ue(WebSocket.prototype, ie, l);
            } else
              !(function() {
                for (
                  var e = function(e) {
                      ...
                      self.addEventListener(
                        ...
                        function(e) {
                          ...
                          for (r = o ? o.constructor.name + '.' + n : 'unknown.' + n; o; )
                            o[n] && !o[n][pe] && (((t = f(o[n], r))[pe] = o[n]), (o[n] = t)), (o = o.parentElement);
                        },
                        !0
                      );
                    },
                ...
                u &&
                  (function(t, n) {
                    var s = n.WebSocket;
                    n.EventTarget || B(n, [s.prototype]),
                      (n.WebSocket = function(t, n) {
                        var c,
                          u,
                          l = arguments.length > 1 ? new s(t, n) : new s(t),
                          p = e(l, 'onmessage');
                        return (
                          p && !1 === p.configurable
                            ? ((c = r(l)),
                              (u = l),
                              [a, i, 'send', 'close'].forEach(function(e) {
                                c[e] = function() {
                            ...
                            : (c = l),
                          O(c, ['close', 'error', 'message', 'open'], u),
                          c
                        );
                      });
                    var c = n.WebSocket;
        ...
        Zone.__load_patch('util', function(e, t, n) {
          (n.patchOnProperties = O), (n.patchMethod = C), (n.bindArguments = _);
        }),
          Zone.__load_patch('timers', function(e) {
            X(e, 'set', 'clear', 'Timeout'), X(e, 'set', 'clear', 'Interval'), X(e, 'set', 'clear', 'Immediate');
          }),
            ...
            e[r] && (t[r] = e[r]),
              ...
              (function(e, t) {
                ...
                for (d = 0; d < n.length; d++)
                  for (var y = i[d], k = (F[y] = {}), m = 0; m < ce.length; m++) {
                    var _;
                    k[(_ = ce[m])] = y + '.addEventListener:' + _;
                  }
                var b = [];
          ...
          Zone.__load_patch('on_property', function(t, n, r) {
            le(0, t),
              (Object.defineProperty = function(e, t, n) {
                ...
                return 'prototype' !== t && (n = Y(e, t, n)), Q(e, t, n, r);
              }),
              ...
              (function(n) {
                if ((E || S) && 'registerElement' in t.document) {
                        ...
                        o.forEach(function(t) {
                          ...
                          if (c.hasOwnProperty(t)) {
                            ...
                            u && u.value
                              ? ((u.value = f(u.value, s)),
                                (i = (a = u).configurable),
                                Q((r = n.prototype), (o = t), (a = Y(r, o, a)), i))
                              : (c[t] = f(c[t], s));
                          } else c[t] && (c[t] = f(c[t], s));
                        }),
                      r.call(document, t, n)
                    );
                  }),
            ...
            !(function(t) {
              ...
              function y(e) {
                ...
                var t = e.data,
                  r = t.target,
                  i = r[o];
                l || ((l = r[s]), (p = r[c])), i && p.call(r, v, i);
                var u = (r[o] = function() {
                  r.readyState === r.DONE && !t.aborted && XMLHttpRequest[a] && e.state === g && e.invoke();
                });
                return l.call(r, v, u), r[n] || (r[n] = e), b.apply(r, t.args), (XMLHttpRequest[a] = !0), e;
              }
              function k() {}
              function m(e) {
                var t = e.data;
              ...
              var _ = C(u, 'open', function() {
                  return function(e, t) {
                    return (e[r] = 0 == t[2]), (e[i] = t[1]), _.apply(e, t);
                  };
                }),
                b = C(u, 'send', function() {
                  return function(e, t) {
                    return e[r]
                      ...
                      : h(
                          'XMLHttpRequest.send',
                          k,
                          { target: e, url: e[i], isPeriodic: !1, delay: null, args: t, aborted: !1 },
                          y,
                          m
                        );
                  };
                }),
                T = C(u, 'abort', function() {
                  return function(e) {
                    var t = e[n];
                  ...
                  var r = t.constructor.name,
                    o = function(o) {
                      ...
                      if (i) {
                        ...
                        t[a] = (function(e) {
                          var t = function() {
                            return e.apply(this, _(arguments, r + '.' + a));
                          };
                          return I(t, e), t;
                        })(i);
                      }
